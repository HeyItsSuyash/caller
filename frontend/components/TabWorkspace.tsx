    ...
    <div className="flex-1 flex flex-col min-w-0 bg-black p-8 overflow-y-auto scrollbar-hide text-white">
      <div className="max-w-6xl mx-auto w-full space-y-8 pb-16 relative">
        ...
        <div className="flex justify-between items-center border-b border-white/5 pb-6">
          <div>
            <h1 className="text-2xl font-black tracking-tighter uppercase italic text-white font-display">Workspace Hub</h1>
            <p className="text-xs font-semibold text-neutral-500 uppercase tracking-widest mt-1">Manage team directories, review telephony usages, and configure subscription billing</p>
          </div>
        </div>

        {/* Subscription / Plan overview card */}
        <div className="p-8 border border-white/10 rounded-[2rem] bg-[#0a0a0a] shadow-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative overflow-hidden">
          ...
          <div className="space-y-3">
            ...
            <h2 className="text-xl font-black text-white font-display">CALLER OS Enterprise Subscription</h2>
          ...
          <div className="p-6 bg-black border border-white/10 rounded-2xl flex flex-col justify-between w-full md:w-64 shrink-0">
            ...
            <button className="w-full mt-4 py-2.5 bg-white text-black text-[9px] font-black uppercase tracking-widest rounded-xl hover:bg-neutral-100 transition-all cursor-pointer">
              Manage Billing
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex justify-between items-center px-2">
              <h3 className="text-xs font-black uppercase tracking-widest text-neutral-500 font-display">Workspace Directory</h3>
                  ...
                  {team.map((member, i) => (
                    <tr key={i} className="hover:bg-white/[0.01] transition-colors group">
                      ...
                      <td className="px-6 py-4">
                        <span className="px-2 py-0.5 bg-black border border-white/10 rounded-md text-[8.5px] font-black text-neutral-400 uppercase tracking-tight">
                          {member.role}
                        </span>
                      </td>
            ...
            {/* Quick Invite Form */}
            <form onSubmit={handleInvite} className="p-6 bg-[#0a0a0a] border border-white/5 rounded-3xl flex flex-col md:flex-row gap-4 items-end shadow-md">
              <div className="flex-1 space-y-2 w-full">
                ...
                <input 
                  ...
                  className="w-full px-4 py-3 bg-black border border-white/10 text-white rounded-xl text-xs font-semibold focus:border-white focus:ring-0"
                />
              </div>
              ...
              <button 
                type="submit"
                className="py-3 px-6 bg-white text-black text-[9px] font-black uppercase tracking-widest rounded-xl hover:bg-neutral-100 transition-all cursor-pointer flex items-center justify-center gap-1.5 font-display shrink-0 w-full md:w-auto"
              >
          ...
          <div className="space-y-6">
            <h3 className="text-xs font-black uppercase tracking-widest text-neutral-500 px-2 font-display">Quota Allocations</h3>
            ...
            <div className="p-6 border border-white/5 rounded-3xl bg-[#0a0a0a] space-y-4 shadow-lg">
