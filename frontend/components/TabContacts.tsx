...
const TabContacts = () => {
  ...
  const leads = [
    ...
    { id: 3, name: 'Priya Das', phone: '+91 76543 21098', interest: 'M.Tech AI', status: 'Cold', priority: 'low', time: '5h ago', stage: 'Follow Up' },
    { id: 4, name: 'Siddharth Singh', phone: '+91 65432 10987', interest: 'Ph.D Physics', status: 'Hot', priority: 'high', time: 'Yesterday', stage: 'Interested' },
    ...
    { id: 6, name: 'Ananya Roy', phone: '+91 89012 34567', interest: 'MBA Marketing', status: 'Warm', priority: 'medium', time: '4 days ago', stage: 'Lost' }
  ];
    ...
    <div className="flex-1 flex flex-col min-w-0 bg-transparent p-6 overflow-y-auto scrollbar-hide text-white">
      <div className="max-w-6xl mx-auto w-full space-y-8 pb-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/5 pb-6">
          <div>
            <h1 className="text-2xl font-black tracking-tighter uppercase italic text-white font-display">CRM Contact Base</h1>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-white/[0.02] border-b border-white/5 text-[9px] font-black uppercase tracking-widest text-neutral-500">
                  ...
                  <th className="px-6 py-4">Conversion Quality</th>
              ...
              <tbody className="divide-y divide-white/5">
                {leads.map((lead) => (
                  <tr key={lead.id} className="hover:bg-white/[0.02] transition-colors group text-xs font-semibold">
                    <td className="px-6 py-4.5">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-bold text-white font-display">{lead.name}</span>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4.5 text-neutral-500 font-mono">
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-start">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-black text-white font-display">{selectedLead.name}</h3>
